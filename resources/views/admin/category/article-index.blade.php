    ...
    <div class="col-4">
        <ul class="list-group">
            ...
            <li class="list-group-item">
                @include('error.note')
                <form action="{{ route('articlecate.index') }}" method="post">
                    @csrf
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center d-flex justify-content-around">
                                <form action="{{route('articlecate.edit', $value->cate_id)}}" method="GET">
                                    <button class="btn btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                </form>

                                <form action="{{route('articlecate.delete', $value->cate_id)}}" method="POST">
                                    @method('DELETE')
                                    @csrf
