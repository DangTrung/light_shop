    ...
    <div class="row my-5">
        ...
        <div class="col-9 d-flex flex-wrap">
            <div class="col-md-12 py-4 mb-4 bg-whitesmoke d-flex justify-content-between align-items-center">
                <div class="show">
                    <p class="m-0 text-only text-uppercase font-weight-bold ml-3">Showing {{$prod_count}} result</p>
                </div>
                <div class="sort">
                    <div class="dropdown">
            ...
            <div class="col-md-4 my-5 Products_row_col-4">
                ...
                <div class="product-bottom text-center mt-4">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="m-0 text-secondary font-weight-bold mr-2"><strike>$&nbsp{{number_format($item->prod_price, 2)}}</strike></p>
