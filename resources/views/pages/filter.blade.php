    ...
    <div class="row my-5">
        ...
        <div class="col-9 d-flex flex-wrap">
            ...
            <div class="col-md-12 animate__animated animate__fadeInRight">
                <div class="title">
                    <h4 class="font-weight-bold text-uppercase">filter with price between <span class="text-success">$&nbsp0</span> to 
                        <span class="text-success">$&nbsp{{ $price }}</span>
                    </h4>
                </div>
                <div class="show">
                    <h5 class="text-uppercase text-only font-weight-bold">Have {{ $count }} result</h5>
                </div>
            </div>
