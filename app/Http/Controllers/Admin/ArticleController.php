...
class ArticleController extends Controller
{
    ...
    {
        $articles = DB::table('articles')->join('articles_cate', 'articles.art_cate', '=', 'articles_cate.cate_id')->orderByDesc('art_id')->get();
    ...
    {
        $art_cate = DB::table('articles')->join('articles_cate', 'articles.art_cate', '=', 'articles_cate.cate_id')->where('art_id', $id)->first();
